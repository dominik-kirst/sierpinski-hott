...
The Coq code is available on GitHub (\url{https://github.com/dominik-kirst/sierpinski-hott}) and as \href{https://github.com/HoTT/HoTT/pull/1533}{pull request} against the HoTT library.
